...
#> Imported DEMO1 bundle -> /tmp/RtmpDYFoBm/msaVariant_cache_1d5b38c8eb65/0.1.0/DEMO1.rds
```
...
cache_location()
#> [1] "/tmp/RtmpDYFoBm/msaVariant_cache_1d5b38c8eb65"
cache_summary()
#>    gene size_kb  cached_on
#> 1 DEMO1     3.1 2026-07-26
```
