...
#> Imported DEMO1 bundle -> /tmp/RtmpO3yVAI/msaVariant_cache_32e44bd2577c/0.1.0/DEMO1.rds
```
...
cache_location()
#> [1] "/tmp/RtmpO3yVAI/msaVariant_cache_32e44bd2577c"
cache_summary()
#>    gene size_kb  cached_on
#> 1 DEMO1     3.1 2026-07-20
```
