...
crisp at any zoom, and a copy-editor can select the text. The default
`ggsave(".pdf")` device produces this on every platform; `cairo_pdf`
is only an optional refinement for font embedding and needs a
cairo-capable R (on macOS, that means XQuartz is installed).
