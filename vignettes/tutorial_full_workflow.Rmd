...
mainstream protein-MSA tool; we recommend the `msa` Bioconductor
package (it ships MUSCLE/ClustalW/ClustalOmega and stays inside R).
Install it once from Bioconductor by following the one-line command
on its landing page,
