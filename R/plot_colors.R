...
.msa_palette <- function(name) {
    ...
    if (name %in% c("grayscale", "greyscale", "grey", "gray", "bw")) {
        ...
        return(.expand_aa(list(
            ...
            proline = "#F0F0F0", aromatic = "#F0F0F0"
        ), gap = "#FFFFFF"))
    }
...
.scheme_defs <- function(scheme) {
    ...
    if (scheme == "journal") {
        list(
            acmg = c(
                PS1 = "#67000D", PM1 = "#A50026", PM2 = "#D73027",
            ...
            msa = "journal",
            clinvar = c(
                Pathogenic = "#B2182B", Likely_pathogenic = "#EF8A62",
        ...
        list(
            acmg = c(
                PS1 = "#000000", PM1 = "#D55E00", PM2 = "#CC79A7",
            ...
            msa = "colorblind",
            clinvar = c(
                Pathogenic = "#D55E00", Likely_pathogenic = "#E69F00",
        ...
        list(
            acmg = c(
                PS1 = "#000000", PM1 = "#3B3B3B", PM2 = "#636363",
            ...
            msa = "grayscale",
            clinvar = c(
                Pathogenic = "#000000", Likely_pathogenic = "#525252",
